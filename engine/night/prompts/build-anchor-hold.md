...
1. `web/site/games/anchor-hold/index.html` — the game (single self-contained file)
2. `web/site/games/anchor-hold/copy.md` — social captions
...
## The game: ANCHOR HOLD

- **Conditioned path (the hook):** the compulsive thumb-check — opening the app to feel grounded, landing in more chaos. The player's thumb already knows this move from Instagram/TikTok — the game IS that move.
- **Mechanic:** A glowing anchor sits on a dark sea. Hold your thumb on it: while held, the water calms, ripples still, and a progress arc fills slowly. Release early and the water stirs again; hold to the end of the arc and the screen settles to flat black with a soft chime. One hold, one resolution.
- **Engine:** calm. **Circuits:** 05-ease, 07-timing, 06-zeigarnik.
- **Video trick:** calm completion — the stilling sea is the payoff — the demo/hook clip must land this.
...
- Includes in order: `window.LOOP_GAME='anchor-hold'` → loop-events.js → juice.js → share.js.
...
```
# ANCHOR HOLD — copy
## TikTok (3 captions ≤100 chars, hook-first, calm completion — the stilling sea is the payoff angle)
## Reels (3)
## Shorts titles (3)
## Hashtags (5)
```
...
Write both files now. Do not modify ANY other file. No build steps. Output "BUILD DONE: anchor-hold" when finished.
