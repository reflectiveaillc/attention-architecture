...
1. `web/site/games/unsent-draft/index.html` — the game (single self-contained file)
2. `web/site/games/unsent-draft/copy.md` — social captions
...
## The game: Unsent Draft

- **Conditioned path (the hook):** draft anxiety / posting hesitation. The player's thumb already knows this move from Instagram/TikTok — the game IS that move.
- **Mechanic:** A 'Post' button hovers. Hold it down while a second counter fills. Release early and the draft vanishes; release late and it auto-posts cringe. The fill pauses unpredictably.
- **Engine:** viral. **Circuits:** 03-social, 04-loss, 08-investment.
...
- Includes in order: `window.LOOP_GAME='unsent-draft'` → loop-events.js → juice.js → share.js.
...
Write both files now. Do not modify ANY other file. No build steps. Output "BUILD DONE: unsent-draft" when finished.
