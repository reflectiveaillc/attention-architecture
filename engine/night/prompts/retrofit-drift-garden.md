...
Upgrade `web/site/games/drift-garden/index.html`. This is a CALM-engine game: J.calm only, no dares, no tension riser, soft demo arc (settle → deepen → resolve → invitation).
