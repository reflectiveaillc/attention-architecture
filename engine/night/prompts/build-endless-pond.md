...
1. `web/site/games/endless-pond/index.html` — the game (single self-contained file)
2. `web/site/games/endless-pond/copy.md` — social captions
...
- **Mechanic:** Scroll a pond surface downward. Lotus pads drift by; catch a petal by tapping, but the pond never ends and never scores. Each petal brightens the water for a moment, then fades. The scroll habit becomes a slow contemplation.
- **Engine:** calm. **Circuits:** 01-soft-rpe, 05-ease, 07-timing, 02-novelty.
...
- Includes in order: `window.LOOP_GAME='endless-pond'` → loop-events.js → juice.js → share.js.
...
Write both files now. Do not modify ANY other file. No build steps. Output "BUILD DONE: endless-pond" when finished.
