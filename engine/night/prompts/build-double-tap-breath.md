...
1. `web/site/games/double-tap-breath/index.html` — the game (single self-contained file)
2. `web/site/games/double-tap-breath/copy.md` — social captions
...
- **Mechanic:** A heart gently expands and contracts. Double-tap on the exact exhale beat to sound a soft chime. The heart animation hijacks the like reflex and redirects it into paced breathing.
...
- Includes in order: `window.LOOP_GAME='double-tap-breath'` → loop-events.js → juice.js → share.js.
...
Write both files now. Do not modify ANY other file. No build steps. Output "BUILD DONE: double-tap-breath" when finished.
