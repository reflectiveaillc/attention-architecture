...
1. `web/site/games/suggested-dismiss/index.html` — the game (single self-contained file)
2. `web/site/games/suggested-dismiss/copy.md` — social captions
...
## The game: Suggested Dismiss

- **Conditioned path (the hook):** 'Suggested for you' / People you may know. The player's thumb already knows this move from Instagram/TikTok — the game IS that move.
- **Mechanic:** Suggested profile cards slide in; tap to dismiss each one you DON'T know — but some are people you actually know and must keep. Wrong dismiss and you've burned a real contact.
- **Engine:** viral. **Circuits:** 02-novelty, 03-social, 04-loss.
...
- Includes in order: `window.LOOP_GAME='suggested-dismiss'` → loop-events.js → juice.js → share.js.
...
Write both files now. Do not modify ANY other file. No build steps. Output "BUILD DONE: suggested-dismiss" when finished.
