...
<title>Tilt — tiny games, honest hooks</title>
<style>${CSS}
...
<footer>built by the LOOP factory · ${registry.games.length} games · local preview</footer>
<script>
...
<script src="js/loop-events.js"></script>
  ...
  for (const g of registry.games) {
    const variants = (g.variants || []).map((v) => `
      <a class="variant" href="../games/${g.id}/variants/${v.id}/">
...
<div class="wrap">
  ...
  ${variants || '<p class="none">base version only — variants appear here when the loop breeds them from your play data.</p>'}
</div>
<script src="../js/loop-events.js"></script>
</body></html>`;
